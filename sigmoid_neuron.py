...
class sigmoidNeuron: # Class for creating an instance of sigmoid neuron 
    ...
    def activation(self, inputs): # Calculate value of this neuron (How active it is), self - instance of sigmoid class, inputs - np array of input values into the neuron
...
if __name__ == "__main__": # Run this testing code when sigmoid neuron file called directly 
    ...
    print("Activation of this neuron is ", neuron.activation([0.2, 0.9, 2, 1, 0.5]))
